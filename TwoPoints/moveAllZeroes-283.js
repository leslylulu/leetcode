...
var moveZeroes = function (nums) {
	...
	for(let right = 0; right < nums.length; right++){
		console.log(`L: ${left}, R: ${right}`, nums)
		if(nums[right] !== 0){
...
let array1 = [0, 1, 0, 98, 12];
let array2 = [0, 0, 1];
let array3 = [45192, 0, -659, -52359, -99225, -75991, 0, -15155, 27382, 59818, 0, -30645, -17025, 81209, 887, 64648];
let result = moveZeroes(array1);
